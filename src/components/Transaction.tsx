...
export const Transaction: React.FC<Props> = ({ transaction }) => {
  ...
  return (
    <div>
      ...
      <button className={transaction.amount > 0 ? 'iconEdit' : 'iconEditMinus'} disabled={true ? isUpdate : false} onClick={()=> updateTransaction({id: transaction.id, update: true})} >Update</button> 
